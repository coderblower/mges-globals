...
const Admin_Contract_Letter_Candidate_Single_With_Form = () => {
                  ...
                  <tr key={item.id} className="whitespace-nowrap">
                    ...
                    <th>
                      <div className="flex gap-4 items-center justify-between">
                        ...
                        <NavLink to={`/admin/contract_letter/contract_letter_view/${item.id}`}>
                          <img
                            src={
                              item?.candidate?.approval_status === "reject" ||
                              item?.candidate?.approval_status === "pending"
...
export default Admin_Contract_Letter_Candidate_Single_With_Form;
